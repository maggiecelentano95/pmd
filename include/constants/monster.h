...
#define MONSTER_GROOKEY 424

#define NUM_MONSTERS MONSTER_GROOKEY
#define MONSTER_MAX (MONSTER_GROOKEY + 1)
...
// For dialogue strings
#define DIALOGUE_MONSTER_PLAYER MONSTER_MAX + 1
#define DIALOGUE_MONSTER_PARTNER MONSTER_MAX + 2
#define DIALOGUE_MONSTER_NONE MONSTER_MAX + 3
