...
static const s16 gStarters[NUM_PERSONALITIES][2] = {
    ...
    */
       [HARDY  ] = { MONSTER_GROOKEY, MONSTER_PSYDUCK },
    [DOCILE ] = { MONSTER_GROOKEY,  MONSTER_PSYDUCK },
    [BRAVE  ] = { MONSTER_GROOKEY,     MONSTER_PSYDUCK },
    [JOLLY  ] = { MONSTER_GROOKEY,   MONSTER_PSYDUCK },
    [IMPISH ] = { MONSTER_GROOKEY,    MONSTER_PSYDUCK },
    [NAIVE  ] = { MONSTER_GROOKEY,   MONSTER_PSYDUCK },
    [TIMID  ] = { MONSTER_GROOKEY,  MONSTER_PSYDUCK },
    [HASTY  ] = { MONSTER_GROOKEY,    MONSTER_PSYDUCK },
    [SASSY  ] = { MONSTER_GROOKEY,    MONSTER_PSYDUCK },
    [CALM   ] = { MONSTER_GROOKEY,     MONSTER_PSYDUCK },
    [RELAXED] = { MONSTER_GROOKEY,    MONSTER_PSYDUCK },
    [LONELY ] = { MONSTER_GROOKEY,     MONSTER_PSYDUCK },
    [QUIRKY ] = { MONSTER_GROOKEY,     MONSTER_PSYDUCK }
};
