...
static const s16 gStarters[NUM_PERSONALITIES][2] = {
    ...
    */
       [HARDY  ] = { MONSTER_GROOKEY, MONSTER_GROOKEY },
    [DOCILE ] = { MONSTER_GROOKEY,  MONSTER_GROOKEY },
    [BRAVE  ] = { MONSTER_GROOKEY,     MONSTER_GROOKEY },
    [JOLLY  ] = { MONSTER_GROOKEY,   MONSTER_GROOKEY },
    [IMPISH ] = { MONSTER_GROOKEY,    MONSTER_GROOKEY },
    [NAIVE  ] = { MONSTER_GROOKEY,   MONSTER_GROOKEY },
    [TIMID  ] = { MONSTER_GROOKEY,  MONSTER_GROOKEY },
    [HASTY  ] = { MONSTER_GROOKEY,    MONSTER_GROOKEY },
    [SASSY  ] = { MONSTER_GROOKEY,    MONSTER_GROOKEY },
    [CALM   ] = { MONSTER_GROOKEY,     MONSTER_GROOKEY },
    [RELAXED] = { MONSTER_GROOKEY,    MONSTER_GROOKEY },
    [LONELY ] = { MONSTER_GROOKEY,     MONSTER_GROOKEY },
    [QUIRKY ] = { MONSTER_GROOKEY,     MONSTER_GROOKEY }
};
